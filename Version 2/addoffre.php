...
<body>
	...
	<div class="page-content" style="	height:1150px ;">
		<div class="form-v1-content" >
			...
			<form class="form-register" name ="form" action="add.php" method="post"  enctype="multipart/form-data">
				<div id="form-total">
						...
						<div class="form-holder ">
							<div class="diplomes">
								<fieldset>
									...
									<input type="checkbox" name="diplomes" value="mastere" /> <label for="mastere">Mastère</label><br>
 ...
 <br>
				...
				<input type="button" id='btn' name='btn' value="Envoyer" onclick="submit_offre()"/>
			</div>
				</div>
