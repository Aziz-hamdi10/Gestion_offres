                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav" >
                        <ul class="navbar-nav ms-lg-auto">
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="utilisateurE.php">Home</a>
                            </li>
                            ...
                            <li class="nav-item">
                            <a class="nav-link click-scroll" type="button"  href="utilisateurE.php"data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Add offre</a>
                            </li>
