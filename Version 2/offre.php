...
if(isset($_SESSION['email'] )   )
{
  ...
  ';
    ...
    echo' <li>  <a href="utilisateur1.php#ofr">all offre</a></li>
    <li>  <a href="utilisateur1.php?filtrer=PRICES">Prices</a></li>
    <li>  <a href="utilisateur1.php?filtrer=DISPO">Disponible</a></li>';

  }
 
}
else{
  echo' <li>  <a href="homeL.php#ofr">all offre</a></li>
  <li>  <a href="homeL.php?filtrer=PRICES">Prices</a></li>
  <li>  <a href="homeL.php?filtrer=DISPO">Disponible</a></li>';
