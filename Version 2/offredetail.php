...
<nav class='nav'>
   <a  class='login' style=' padding-left:30px; padding-top:10px;padding-bottom:10px;padding-right:30px;'href='HomeL.php?error=Login!'>Login</a>
     ...
     <div class='row'>
       <div class='col-lg-5'>
         ...
         <ul><h6>Posted by :".$r1[0]['nom_entreprise']." <h6><br>
           ...
           <a href='homeL.php'class='btn'style='background-color:#777'>Back</a>
           <a href='homeL.php?error=Login svp !'class='btn'style='background-color:green'>consulter</a>
";
